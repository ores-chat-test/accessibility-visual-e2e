# accessibility-visual-e2e

Status: **contract-only**. This suite specifies keyboard, contrast, focus, text scaling, and semantic accessibility checks across chat surfaces.
